...
void DrawLine(Mat result_image, Point point1, Point point2, Scalar passed_colour=-1.0)
{
	...
	arrowedLine( result_image, point1, point2, (passed_colour.val[0] == -1.0) ? colour : passed_colour );
}
...
void NonMaximaEdgeGradientSuppression( Mat& gradients, Mat& orientations, Mat& nms_result, float min_gradient )
{
/*
